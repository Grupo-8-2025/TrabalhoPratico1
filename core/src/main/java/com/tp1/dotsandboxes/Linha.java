...
public class Linha {
    ...
    private long desenhadaTimestamp = 0;
    ...
    public void setDesenhada(boolean desenhada) {
        ...
        if (desenhada) {
            this.desenhadaTimestamp = System.currentTimeMillis();
        }
    }
    ...
    public long getDesenhadaTimestamp() {
        return desenhadaTimestamp;
    }
